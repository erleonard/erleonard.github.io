...
Using Duo Security, I can add two-factor authentication to all Windows login via local console or RDP. Duo provides a free version that supports up to 10 users. Check out the plans comparison table to find out which version is right for you: https://duo.com/pricing
