...
6. Select the **role** you wish assign and type in the **email address**. The user will be notified via email.


If you do this often, you can use powerhsell to assign the new user to the subscription.
